...
const themeStyle = computed(() => ({
  ...
  '--elinea-primary': theme.value?.primary_color || '#177c68',
  '--elinea-secondary': theme.value?.secondary_color || '#153b36',
  '--elinea-accent': theme.value?.accent_color || '#ff6b5f',
  '--elinea-font-body': `"${theme.value?.font_family || 'Georgia'}", Georgia, Cambria, "Times New Roman", serif`,
  '--elinea-font-heading': `"${theme.value?.font_family || 'Georgia'}", Georgia, Cambria, "Times New Roman", serif`,
