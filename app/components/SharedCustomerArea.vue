...
const theme = baseBranding
const themeStyle = computed(() => ({
  '--sf-primary': theme.primary_color,
  '--sf-ink': theme.secondary_color,
  '--sf-accent': theme.accent_color,
  '--sf-body': `"${theme.font_family}", "Segoe UI", Arial, sans-serif`,
  '--sf-display': `"${theme.font_family}", "Segoe UI", Arial, sans-serif`,
}))
